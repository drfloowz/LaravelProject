    ...
    <div class="lg:flex lg:space-x-8">
        ...
        <div class="lg:w-1/3 mt-8 lg:mt-0">
            <div class="bg-gray-50 rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8 sticky top-24">
                ...
                <button type="button" class="w-full flex items-center justify-center px-6 py-4 border border-transparent text-base font-bold rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 transition-colors shadow-md transform hover:-translate-y-0.5">
                    Siparişi Tamamla
